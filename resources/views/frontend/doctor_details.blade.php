...
<div class="card doc-profile-card">
    <div class="card-body">
        <div class="doctor-widget doctor-profile-two">
            <div class="doc-info-left">
                <div class="doctor-img">
                    <img src="{{ asset('backend/assets/img/doctors/doc-profile-02.jpg') }}" class="img-fluid" alt="User Image">
                </div>
                <div class="doc-info-cont">
                    <span class="badge doc-avail-badge"><i class="fa-solid fa-circle"></i>Available </span>
                    <h4 class="doc-name">Dr.Martin Adian <img src="{{ asset('backend/assets/img/icons/badge-check.svg') }}" alt="Img"><span class="badge doctor-role-badge"><i class="fa-solid fa-circle"></i>Dentist</span></h4>
            ...
            <div class="doc-info-right">
                <ul class="doctors-activities">
                    ...
                    <li>
                        <div class="hospital-info">
                            <span class="list-icon"><img src="{{ asset('backend/assets/img/icons/thumb-icon.svg') }}" alt="Img"></span>
                    ...
                    <li>
                        ...
                        <ul class="contact-doctors">
                            <li><a href="chat-doctor.html"><span><img src="{{ asset('backend/assets/img/icons/device-message2.svg') }}" alt="Img"></span>Chat</a></li>
        ...
        <div class="doc-profile-card-bottom">
            <ul>
                <li>
                    <span class="bg-blue"><img src="{{ asset('backend/assets/img/icons/calendar3.svg') }}" alt="Img"></span>
                ...
                <li>
                    <span class="bg-green"><img src="{{ asset('backend/assets/img/icons/bookmark-star.svg') }}" alt="Img"></span>
                    15+ Awards
                </li>
            </ul>
            ...
            <div class="doc-review-card">
                <div class="user-info-review">
                    <div class="reviewer-img">
                        <a href="#" class="avatar-img"><img src="{{ asset('backend/assets/img/clients/client-13.jpg') }}" alt="Img"></a>
