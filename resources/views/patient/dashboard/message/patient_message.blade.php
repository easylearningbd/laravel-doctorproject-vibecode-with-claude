@php
    ...
    $mePhoto = $me->profile_photo
        ...
        : asset('backend/assets/img/doctors-dashboard/profile-06.jpg');
    $meName = $me->first_name . ' ' . $me->last_name;
                ...
                <div class="chat-sec">
                    ...
                    <div class="chat chat-messages" id="middle">
                        ...
                        <div class="chat-empty-state" id="noChatSelected">
                            ...
                            <h6 class="text-muted">Select a doctor to start chatting</h6>
                            <p class="text-muted fs-14">Only doctors with completed appointments are listed.</p>
                        </div>
...
$(function () {
    ...
    function renderContacts(contacts) {
        if (!contacts.length) {
            $('#contactList').html(
                ...
                '<small>No doctors available for chat.<br>Complete an appointment first.</small></li>'
            );
            return;
        }
        var html = '';
    ...
    function setOnlineStatus(isOnline) {
        if (isOnline) {
            ...
            $('#chatHeaderStatus').text('Available').css('color', '#28a745');
        } else {
            $('#chatHeaderAvatar').removeClass('avatar-online');
            $('#chatHeaderStatus').text('Unavailable').css('color', '#9e9e9e');
        }
    }
