        ...
        <div class="dashboard-card w-100">
            ...
            <div class="dashboard-card-body">
                <div class="d-flex recent-patient-grid-boxes">
                    ...
                    <div class="recent-patient-grid">
                        <a href="patient-details.html" class="patient-img">
                            <img src="{{ asset('backend/assets/img/doctors-dashboard/profile-02.jpg') }}" alt="Img">
                        </a>
        ...
        <div class="upcoming-appointment-card">
            ...
            <div class="upcoming-patient-info">
                <div class="info-details">
                    <span class="img-avatar"><img src="{{ asset('backend/assets/img/doctors-dashboard/profile-01.jpg') }}" alt="Img"></span>
                    <div class="name-info">
                        <span>#Apt0001</span>
                ...
                <div class="circle-bg">
                    <img src="{{ asset('backend/assets/img/bg/dashboard-circle-bg.png') }}" alt="Img">
                </div>
            </div>
        ...
        <tr>
            ...
            <td>
                <div class="apponiment-view d-flex align-items-center">
                    <a href="invoice-view.html"><i class="isax isax-eye4"></i></a>
                </div>
            </td>
        </tr>
        <tr>
